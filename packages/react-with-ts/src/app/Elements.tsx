...
export class ElementsPage extends PureComponent<IProps, IState> {
  render() {
    return (
      <Fragment>
        <Header />
          ...
          <div className="inner">
            ...
            <div className="row">
              <section className="6u 12u$(medium)">
                ...
                <p>
                  <strong>Baseline</strong> is a simple boilerplate for creating
                  new projects with <a href="http://skel.io">Skel</a>. It
                  features clear, concise HTML5 and CSS3 code (built on{" "}
                  <a href="http://sass-lang.com">Sass</a>), responsiveness right
                  out of the box, off-canvas navigation, an assortment of
                  pre-styled elements,{" "}
                  <a href="http://fontawesome.io">Font Awesome</a> icons, and
                  everything offered by Skel + Skel.scss. Baseline is{" "}
              ...
              <section className="3u 6u(medium) 12u$(small)">
                ...
                <p>
                  ...
                  accumsan felis sed dolor interdum ut. Amet accumsan magna
                  etiam orci faucibus interdum et lorem ipsum et nullam.
                </p>
              </section>
              <section className="3u$ 6u$(medium) 12u$(small)">
                <h3>Lorem Ipsum</h3>
